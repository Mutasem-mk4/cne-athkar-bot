...
```
5. إذا كان لديك أكثر من قروب، استخدم:
```
GROUP_CHAT_IDS=-1001234567890,-1009876543210
```
6. أعد تشغيل البوت

يمكنك أيضاً إرسال أي رسالة في كل قروب بعد إضافة البوت حتى يسجل القروب تلقائياً في MongoDB. استخدم أمر `/groups` من حساب المسؤول للتأكد من كل القروبات التي سيرسل لها البوت.
